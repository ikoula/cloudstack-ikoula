<?php
        ...
        print "Adresse ip privée/guest de votre instance Mysql:";
        $ipmysql = trim(fgets(STDIN));
        /* le port SSH depuis lequel vous pourrrez vous connecter sur cette instance via l'adresse ip publique*/
        print "Port SSH publique à utiliser pour cette instance :";
        ...
        //Première instance :
                ...
                */
                ...
                $vm01['conf']['userdata'] = "echo $ipmysql > /tmp/nfsserver && puppet module install ikoula/wp_apache_nfs && puppet apply -e \"include wp_apache_nfs\"";
