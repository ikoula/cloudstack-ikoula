<?php
        ...
        //Première instance :
                ...
                */
                $vm01['conf']['serviceofferingid'] = "<ID DE L'OFFRE DE SERVICE QUE VOUS SOUHAITEZ UTILISER>";
                ...
                */
                $vm01['conf']['templateid'] = "<ID DU TEMPLATE A UTILISER>";
...
/*-------------------------------- Création des règles de sortie --------------------------------*/
        ...
        // Finalisation
        echo "D'ici quelques dizaines de secondes, vous pourrez vous connecter à l'adresse http://".$vm01['conf']['publicIPid'];
        echo "afin de finaliser la configuration de votre installation de WordPress.";
